...
static const struct SpriteFrameImage sPicTable_RepartidorTipoAgua[] = {
    overworld_frame(gObjectEventPic_RepartidorTipoAgua, 2, 4, 0),
    overworld_frame(gObjectEventPic_RepartidorTipoAgua, 2, 4, 1),
    overworld_frame(gObjectEventPic_RepartidorTipoAgua, 2, 4, 2),
};

static const struct SpriteFrameImage sPicTable_RepartidorTipoFuego[] = {
    overworld_frame(gObjectEventPic_RepartidorTipoFuego, 2, 4, 0),
    overworld_frame(gObjectEventPic_RepartidorTipoFuego, 2, 4, 1),
    overworld_frame(gObjectEventPic_RepartidorTipoFuego, 2, 4, 2),
};

static const struct SpriteFrameImage sPicTable_RepartidorTipoPlanta[] = {
    overworld_frame(gObjectEventPic_RepartidorTipoPlanta, 2, 4, 0),
    overworld_frame(gObjectEventPic_RepartidorTipoPlanta, 2, 4, 1),
    overworld_frame(gObjectEventPic_RepartidorTipoPlanta, 2, 4, 2),
};
