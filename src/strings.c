...
const u8 gText_PlayerName[] = _("Usted"); //nombre por defecto
...
const u8 gText_FlyToWhere[] = _("A dónde vuelas?");
...
const u8 gText_PokeBallsPocket[] = _("Poké Bolas");
...
const u8 gText_ShopSell[] = _("Vende");
...
const u8 gText_AnythingElseICanHelp[] = _("Algo más en lo que pueda\nayudar?");
...
const u8 gText_Poke_Balls[] = _("Poké bolas");
