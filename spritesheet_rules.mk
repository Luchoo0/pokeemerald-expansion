...
$(OBJEVENTGFXDIR)/people/repartidor_tipo_agua.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/repartidor_tipo_fuego.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/repartidor_tipo_planta.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
