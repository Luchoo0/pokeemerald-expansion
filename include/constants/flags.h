...
#define FLAG_PRIMER_ENCUENTRO_CON_RIVAL      0x54  // Usada por mi
...
#define FLAG_HIDE_PRIMER_ENCUENTRO_RIVAL     0x68  // Unusada por mi
...
#define FLAG_SYS_B_DASH                             (SYSTEM_FLAGS + 0x60) // Unused Flag
